...
Map = {
    ...
    ServerConnect: function () {
        ...
        this.SocketServer.on('connect', function () {
            window.top.Map.SocketServer.emit('pass-connection', window.top.Map._Version);
        });
        ...
        this.SocketServer.on('recieve-mapdata', function (place, location, level, cellnames, celldatas) {
            ...
            for (var cellcount = 0; cellcount < cellnames.length; cellcount++) {
                cellx = cellnames[cellcount].split('x')[0]; celly = cellnames[cellcount].split('x')[1];
    ...
    DefineWorldLocation: function () {
        ...
        if(xmlhttp.status == 200) {
            ...
            if ((this.CurPlace == 1 && this.CurLocation == 1) || (this.CurPlace == 28)) {
                if(this.CurPlace == 1 && this.CurLocation == 1) {this.CurPlLocName = "Пустошь";}
                if (this.CurPlace == 28) {this.CurPlLocName = "Пустота";}
            } else {
                //place technical link
                var splitpllist = t_pl_list.split(' '+this.CurPlace+' ')[1];
                var symbolP = ''; var iP = 0; var contP = true;
                do {
                    if (iP == splitpllist.split(' ').length - 1) {
                        ...
                        if (symbolP == '0' || symbolP == '1' || symbolP == '2' || symbolP == '3' || symbolP == '4' || symbolP == '5' || symbolP == '6' || symbolP == '7' || symbolP == '8' || symbolP == '9') {
                            ...
                            this.CurPlLocName += splitpllist.split(' ')[iP];
                            if (symbolP === undefined) {contP = false;}
                            iP++;
                        }
                    }
                    
                    if (contP) {this.CurPlLocName += ' ';} else {this.CurPlLocName += ': ';}
                } while(contP);
                
                //location technical link
                var splitloclist = t_loc_list.split(' '+this.CurLocation+' '+this.CurPlace+' ')[1];
                var symbolL = ''; var iL = 0; var contL = true;
                do {
    ...
    InitChatControls: function () {
        ...
        window.top.chat.fortismapcontrols.document.getElementById('fmt-scrbar-1').onclick = function() {window.top.loc.inv_snd.location.href='/cgi/inv_wear.php?id=588'; return false;};
        window.top.chat.fortismapcontrols.document.getElementById('fmt-scrbar-2').onclick = function() {window.top.loc.inv_snd.location.href='/cgi/inv_wear.php?id=586'; return false;};
        window.top.chat.fortismapcontrols.document.getElementById('fmt-scrbar-3').onclick = function() {window.top.loc.inv_snd.location.href='/cgi/inv_wear.php?id=589'; return false;};
        window.top.chat.fortismapcontrols.document.getElementById('fmt-scrbar-4').onclick = function() {window.top.loc.inv_snd.location.href='/cgi/inv_wear.php?id=587'; return false;};
        window.top.chat.fortismapcontrols.document.getElementById('fmt-scrbar-5').onclick = function() {window.top.loc.inv_snd.location.href='/cgi/inv_wear.php?id=590'; return false;};
        window.top.chat.fortismapcontrols.document.getElementById('fmt-scrbar-6').onclick = function() {window.top.loc.inv_snd.location.href='/cgi/inv_wear.php?id=591'; return false;};
        window.top.chat.fortismapcontrols.document.getElementById('fmt-scrbar-7').onclick = function() {window.top.loc.inv_snd.location.href='/cgi/inv_wear.php?id=592'; return false;};
        ...
        window.top.chat.fortismapcontrols.document.getElementById('fmt-hidebtn').onclick = function() {window.top.Map.HideMap(); return false;};
        window.top.chat.fortismapcontrols.document.getElementById('fmt-unhidebtn').onclick = function() {window.top.Map.ShowMap();return false;};
        window.top.chat.fortismapcontrols.document.getElementById('fmt-reloadbtn').onclick = function() {window.top.Map.ReloadMap(); return false;};
    },
    ...
    InitMapFrame: function () {
        ...
        var mapFrame = '<frame name="fortismapframe" id="fortismapframe" scrolling="yes"></frame>';
...
';
        ...
        for(var y = 0; y <= this.CurDimY + 1; y++) {
            ...
            if (y == 0) {
                ...
                for(var xgrid = 1; xgrid <= this.CurDimX; xgrid++) {mapTable += '<td class="fmt-grid">'+xgrid+'</td>';}
                mapTable += '<td class="fmt-grid"></td></tr>\n';
            }
            //cells
            if (y > 0 && y <= this.CurDimY) {
                mapTable += '<tr><td class="fmt-grid">'+y+'</td>';
                for(var x = 1; x <= this.CurDimX; x++) {mapTable += '<td id="c'+x+'x'+y+'" title="'+x+'x'+y+'"></td>';}
    ...
    ShowMap: function () {
        ...
        {window.top.document.getElementsByTagName('frameset')[0].setAttribute('cols','*,'+this.GetMapFrameSize());} //resize only if 0-width
    },
    ...
    StyleCell: function(pl, loc, fl, x, y) {
        ...
        var cell = false; var time = false; var cellowner = false; var cellold = false;
        if (cellData) {
        ...
        if (cell) {
            ...
            //way-n
            var nearx = parseInt(x); var neary = parseInt(y)-1;
            ...
            //way-w
            var nearx = parseInt(x)-1; var neary = parseInt(y);
    ...
    LocateMe: function() {
        ...
        if(window.top.fortismapframe.document.getElementsByClassName('fmt-me')[0] === undefined)
        {
            ...
            if (this.CurCellHasItems || this.CurCellHasMobs) {
                ...
                if(!myPointElem.classList.contains('fmt-dc-old')) {myPointElem.classList.remove('fmt-dc-old');}
                if(!myPointElem.classList.contains('fmt-dc')) {myPointElem.classList.add('fmt-dc');}
            }
        }
    },
    ...
    ParseMazeFile: function(mazeFile) {
        ...
        var trap = 0; var object = 0;
        var x; var y; var lvl;
        var flag = 0; var up = 0; var down = 0; var exit = 0;
        var move_n = 0; var move_w = 0; var move_e = 0; var move_s = 0;
        var items = false; var mobs = false;
        
        var moofuncstr = mazeFileArr[mazeFileArr.length-3];
        var moofunc = moofuncstr.substr(4, moofuncstr.length-5).split(',');
        x = moofunc[1]; y = moofunc[2]; lvl = moofunc[0];
        
        if (mazeFileStr.indexOf('trap') != -1 || moofunc[4] == "true") {trap = 1;}
        if (mazeFileArr[0].split(',')[1] == 'true') {flag = 1;}
        if (mazeFileArr[3].split(',')[2] == '\'5\'') {up = 1;}
        if (mazeFileArr[8].split(',')[2] == '\'6\'') {down = 1;}
        if (mazeFileArr[1].split(',')[2] == '\'7\'') {exit = 1;}
        if (mazeFileStr.indexOf('Вещитут:') != -1) {items = true;}
        if (mazeFileStr.indexOf('Мобытут:') != -1) {mobs = true;}
        ...
        if (mazeFileArr[2][0] == 'a') {move_n = this.ParseMove(mazeFileArr[2].split(',')[3].substr(1,mazeFileArr[2].split(',')[3].length-7));}
        if (mazeFileArr[4][0] == 'a') {move_w = this.ParseMove(mazeFileArr[4].split(',')[3].substr(1,mazeFileArr[4].split(',')[3].length-7));}
        if (mazeFileArr[5][0] == 'a') {move_e = this.ParseMove(mazeFileArr[5].split(',')[3].substr(1,mazeFileArr[5].split(',')[3].length-7));}
        if (mazeFileArr[7][0] == 'a') {move_s = this.ParseMove(mazeFileArr[7].split(',')[3].substr(1,mazeFileArr[7].split(',')[3].length-7));}
        
        this.CurCoordX = x; this.CurCoordY = y; this.CurLevel = lvl;
        ...
        if (items) {this.CurCellHasItems = true;} else {this.CurCellHasItems = false;}
        if (mobs) {this.CurCellHasMobs = true;} else {this.CurCellHasMobs = false;}
    ...
    ParseMove: function(moveStr) {
        var move;
        switch (moveStr) {
            case 'go2': {move = 2; break;} // red
            case 'go3': {move = 3; break;} // green
            case 'go4': {move = 4; break;} // blue
            case 'go5': {move = 5; break;} // white
            case 'go6': {move = 6; break;} // metal
            case 'go7': {move = 7; break;} // gold
            case 'go8': {move = 8; break;} // mithril
            case 'go9': {move = 9; break;} // ??
            case 'go10': {move = 'a'; break;} // simple
            case 'go11': {move = 'b'; break;} // bone ?
            case 'go12': {move = 'c'; break;} // crystal
            default: {move = 1; break;}
        }
    ...
    DefineTechLocList: function() {
        ...
        xmlhttp.send(null);
        if(xmlhttp.status == 200) {this.SetTechLocList(xmlhttp.responseText);}
    ...
    DefineTechPlList: function() {
        ...
        xmlhttp.send(null);
        if(xmlhttp.status == 200) {this.SetTechPlList(xmlhttp.responseText);}
        return xmlhttp.responseText;
    },
    ...
    GetMapFrameSize: function() {
        ...
        if(mapFrameSize === null) {mapFrameSize = false;}
        return mapFrameSize;
    },
...
',
    ...
    HTML_Controls: '\
<div id="fmt-ctrl-title" style="font-size:12pt; color: white; float: left; padding: 6px 10px 6px 10px;">Картограф FMT v. 5.41</div>\
...
.fmt-me {background-image: url(\'http://lg.fortis-ts.ru/img/online_me.png\') !important;}\
.fmt-me-object {background-image: url(\'http://lg.fortis-ts.ru/img/online_me.png\'), url(\'http://lg.fortis-ts.ru/img/object.png\') !important;}\
.fmt-me-trap {background-image: url(\'http://lg.fortis-ts.ru/img/online_me.png\'), url(\'http://lg.fortis-ts.ru/img/trap.png\') !important;}\
.fmt-me-flag {background-image: url(\'http://lg.fortis-ts.ru/img/online_me.png\'), url(\'http://lg.fortis-ts.ru/img/flag.png\') !important;}\
.fmt-me-up {background-image: url(\'http://lg.fortis-ts.ru/img/online_me.png\'), url(\'http://lg.fortis-ts.ru/img/up.png\') !important;}\
.fmt-me-down {background-image: url(\'http://lg.fortis-ts.ru/img/online_me.png\'), url(\'http://lg.fortis-ts.ru/img/down.png\') !important;}\
.fmt-me-exit {background-image: url(\'http://lg.fortis-ts.ru/img/online_me.png\'), url(\'http://lg.fortis-ts.ru/img/exit.png\') !important;}\
.fmt-pl {background-image: url(\'http://lg.fortis-ts.ru/img/online.png\') !important;}\
.fmt-pl-object {background-image: url(\'http://lg.fortis-ts.ru/img/online.png\'), url(\'http://lg.fortis-ts.ru/img/object.png\') !important;}\
.fmt-pl-trap {background-image: url(\'http://lg.fortis-ts.ru/img/online.png\'), url(\'http://lg.fortis-ts.ru/img/trap.png\') !important;}\
.fmt-pl-flag {background-image: url(\'http://lg.fortis-ts.ru/img/online.png\'), url(\'http://lg.fortis-ts.ru/img/flag.png\') !important;}\
.fmt-pl-up {background-image: url(\'http://lg.fortis-ts.ru/img/online.png\'), url(\'http://lg.fortis-ts.ru/img/up.png\') !important;}\
.fmt-pl-down {background-image: url(\'http://lg.fortis-ts.ru/img/online.png\'), url(\'http://lg.fortis-ts.ru/img/down.png\') !important;}\
.fmt-pl-exit {background-image: url(\'http://lg.fortis-ts.ru/img/online.png\'), url(\'http://lg.fortis-ts.ru/img/exit.png\') !important;}\
...
.fmt-object {background-image: url(\'http://lg.fortis-ts.ru/img/object.png\') !important;}\
.fmt-trap {background-image: url(\'http://lg.fortis-ts.ru/img/trap.png\') !important;}\
.fmt-flag {background-image: url(\'http://lg.fortis-ts.ru/img/flag.png\') !important;}\
.fmt-up {background-image: url(\'http://lg.fortis-ts.ru/img/up.png\') !important;}\
.fmt-down {background-image: url(\'http://lg.fortis-ts.ru/img/down.png\') !important;}\
.fmt-exit {background-image: url(\'http://lg.fortis-ts.ru/img/exit.png\') !important;}\
